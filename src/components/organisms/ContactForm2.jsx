...
function ContactForm2() {
  ...
  return (
    <>
      <div className="container mx-auto w-full flex items-center justify-center my-12">
      ...
      <div className="md:px-20 px-4 py-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center">
            ...
            <button className="text-base font-medium leading-none text-indigo-700 py-4 px-5 bg-white rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:bg-gray-300">
              Get it now
            </button>
          </div>
